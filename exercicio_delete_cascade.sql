...
--Resposta: Nao. Por haver registros de funcionarios com este departamento associado, a FK da tabela de funcionario referenciando departamentos
--nao deixa o departamento ser deletado, gerando um erro de integridade. 
...
--Resposta: Apos mudar a constraint de FK da tabela funcionario que referenciava departamento para ON DELETE CASCADE,
--ao fazer o delete, ele puxa todos os registros que utilizavam aquele dado (no caso, todos os funcionarios que tinham id_departamento = 1
--e deletam tambem. Isso e muito util em desenvolvimento, caso queira apagar varios registros ao mesmo tempo e nao deixar o banco inconsistente
--mas e bastante perigoso em producao.
